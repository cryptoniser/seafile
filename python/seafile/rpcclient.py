...
class SeafileRpcClient(ccnet.RpcClientBase):
    ...
    def seafile_create_repo_cryptostick(name, desc, public_key, public_key_exponent, cs_serial_no, base, relay_id, keep_history):
        pass
    ...
    @searpc_func("string", ["string", "int", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "int", "string"])
    def seafile_clone(repo_id, repo_version, peer_id, repo_name, worktree, token, password, magic, peer_addr, peer_port, email, random_key, cs_random_key, hashed_public_key, selected_hashed_public_key, enc_version, more_info):
        pass
    clone = seafile_clone

    @searpc_func("string", ["string", "int", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "string", "int"])
    def seafile_download(repo_id, repo_version, peer_id, repo_name, wt_parent, token, password, magic, peer_addr, peer_port, email, random_key, cs_random_key, hashed_public_key, selected_hashed_public_key, cs_serial_no, cs_pin, enc_version):
        pass
